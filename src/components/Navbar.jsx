...
import { FaEnvelope, FaPhoneAlt, FaPinterest, FaFacebook, FaTwitter, FaInstagram, FaSearch, FaChevronDown } from 'react-icons/fa';
...
const Navbar = () => {
  ...
  <img src="public/assets/logo.png" alt="Logo" className="w-full h-full object-contain" />
</div>
          ...
          <li className="relative">
            ...
            {dropdownOpen && (
              <ul className="absolute bg-white shadow-lg rounded mt-2 py-2 w-40">
                <li><a href="#service1" className="block px-4 py-2 text-sm hover:bg-gray-100">Service 1</a></li>
                <li><a href="#service2" className="block px-4 py-2 text-sm hover:bg-gray-100">Service 2</a></li>
                <li><a href="#service3" className="block px-4 py-2 text-sm hover:bg-gray-100">Service 3</a></li>
              </ul>
            )}
          </li>
